...
public class MapperCollaCollaListing {
    public static Colla collaListingToColla (CollaListing collaListing) {
        Colla colla = new Colla(collaListing.name(), collaListing.entity(), collaListing.foundationYear(), collaListing.description());
    ...
    public static CollaListing collaToCollaListing (Colla colla) {
        CollaListing collaListing = new CollaListing(colla.getId(), colla.getName(), colla.getEntity(), colla.getFoundationYear(), colla.getDescription());
        return collaListing;
    }
}