            ...
            <div className={styles.userPage__info}  onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={customTheme}>
                <div className={styles.userPage__topLeftPanel}>
                    <div className={styles.userPage__topLeftPanel__container}>
                        <a target="_blank" className={classNames(detailsStyles.digitalProductDetails__aImage, styles.userPage__aImage)}
                           href={lang === defaultLang ? `/users/user.html?userId=${user.id}` : `/users/user.html?userId=${user.id}&lang=${lang}`}>
                            <div className={classNames(detailsStyles.digitalProductDetails__image, styles.userPage__image)}>
                                <img
                        ...
                        {imageFrameUrl && <a target="_blank" className={classNames(detailsStyles.digitalProductDetails__aImageFrame, styles.userPage__aImageFrame)}
                                             href={lang === defaultLang ? `/users/user.html?userId=${user.id}` : `/users/user.html?userId=${user.id}&lang=${lang}`}>
                            <div className={classNames(detailsStyles.digitalProductDetails__imageFrame, styles.userPage__imageFrame)}>
                                <img
                                    src={imageFrameUrl}
                                />
                            </div>
                        </a>}
                        <a target="_blank" className={classNames(detailsStyles.digitalProductDetails__aTitle, styles.userPage__aTitle)}>
                            {title && <div className={classNames(detailsStyles.digitalProductDetails__title, styles.userPage__title)}
