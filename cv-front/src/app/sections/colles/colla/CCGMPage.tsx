...
import styles from "./CCGMPage.module.scss";
...
export function CCGMPage({ colla, lang }: { colla: Colla; lang: string }) {
        ...
        <div className={styles.ccgmPage}>
            <div className={styles.pageWrapper}>
                <div className = {styles.leftLeftContent}>
                    {logoUrl && (
                        <img
                            ...
                            className={styles.ccgmPage__logo}
                        />
                    )}
                </div>
                <div className={styles.leftContent}>
                    ...
                    <h3 className={styles.ccgmPage__name} style={contrastTextColourAndBackground} >{colla.name}</h3>
                    <h6 className={styles.ccgmPage__entity} style={contrastTextColourAndBackground} >{colla.entity}</h6>
                    <p className={styles.ccgmPage__foundationYear} style={contrastTextColour} >{colla.foundationYear}</p>

                    <div className={styles.ccgmPage__characteristics}>
                        ...
                        {colla.instagram && isInstagramVisible && ( <a href={getInstagramUrl(colla.instagram)} target="_blank">
                                <p className={styles.ccgmPage__additionalTextButton} style={contrastBackgroundAndTextColour}>{colla.instagram}</p>
                            </a> )}
                        ...
                        {colla.email && isEmailVisible && ( <a href={`mailto:${colla.email}`} target="_blank">
                                <p className={styles.ccgmPage__additionalTextButton} style={contrastBackgroundAndTextColour}>{colla.email}</p>
                            </a> )}
                    ...
                    <div className={styles.ccgmPage__description} style={contrastTextColourAndBackground} >{colla.description}</div>
                </div>
            </div>
        </div>
    );
