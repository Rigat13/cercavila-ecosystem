...
const SidebarMenu: React.FC<SidebarMenuProps> = ({ isOpen, onClose, lang , otherParams}) => {
    return (
        <div className={`${styles.sidebar} ${isOpen ? styles.open : ''}`}>
            ...
            <div className={styles.languageSelector}>
                ...
                <div className={styles.dropdownContent}>
                    {lang !== defaultLang && <a href={`?${otherParams}&lang=ca`}>{defaultLang}</a>}
                    {lang !== 'en' && <a href={`?${otherParams}&lang=en`}>en</a>}
                    {lang !== 'es' && <a href={`?${otherParams}&lang=es`}>es</a>}
                </div>
            </div>
        </div>
    );
