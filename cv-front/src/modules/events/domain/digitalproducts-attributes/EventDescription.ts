...
export function isDigitalProductDescriptionValid(description: string): boolean {
...
export function DigitalProductDescriptionNotValidError(description: string): Error {
