...
export function ensureDigitalProductIsValid({id, name, description, image, primaryColour, secondaryColour, price, type}: Event): void {
...
export function ensureDigitalProductIsValidEmptyId({id, name, description, image, primaryColour, secondaryColour, price, type}: Event): void {
